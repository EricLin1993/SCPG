function [x,X,status,history] = l1_ls_nonneg(A,varargin)
%
...
%         if ntiter==1
%              imwrite(imind,cm,'test.gif','gif', 'Loopcount',inf,'DelayTime',0.5);
%         else
%              imwrite(imind,cm,'test.gif','gif','WriteMode','append','DelayTime',0.5);
%         end        
%     end
%-------------------------------------------------    
    z = A*x-y;
